...
- fragmented-free-space stream materialization for resident, sparse, compressed, uninitialized-tail,
  and destination-unaligned payloads in create-new exports (implemented; in-place execution remains
  separately gated)
